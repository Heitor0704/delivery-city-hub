          ...
          <div className="mt-6 pt-4 border-t border-gray-200">
            ...
            <div className="grid grid-cols-1 gap-2">
              ...
              <div className="flex justify-between space-x-2">
                <Button type="button" onClick={() => createDemoUser("owner")} disabled={!!isCreatingDemo} variant="outline" className="text-xs py-1 flex-1 h-auto">
                  {isCreatingDemo === "owner" ? <><Loader2 className="h-3 w-3 animate-spin mr-1" /> Dono</> : "Login Dono"}
                </Button>
                <Button type="button" onClick={() => createDemoUser("cityManager")} disabled={!!isCreatingDemo} variant="outline" className="text-xs py-1 flex-1 h-auto">
                  {isCreatingDemo === "cityManager" ? <><Loader2 className="h-3 w-3 animate-spin mr-1" /> Gerente</> : "Login Gerente"}
                </Button>
                <Button type="button" onClick={() => createDemoUser("admin")} disabled={!!isCreatingDemo} variant="outline" className="text-xs py-1 flex-1 h-auto">
                  {isCreatingDemo === "admin" ? <><Loader2 className="h-3 w-3 animate-spin mr-1" /> Admin</> : "Login Admin"}
                </Button>
              </div>
