  ...
  public: {
    Tables: {
      ...
      cities: {
        ...
        Relationships: [
          {
            foreignKeyName: "cities_manager_id_fkey"
            columns: ["manager_id"]
            isOneToOne: false
      ...
      commissions: {
        ...
        Relationships: [
          {
            foreignKeyName: "commissions_deliverer_id_fkey"
      ...
      deliverers: {
        ...
        Relationships: [
          {
            foreignKeyName: "deliverers_city_id_fkey"
            columns: ["city_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "deliverers_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      levels: {
        ...
        Relationships: [
          {
            foreignKeyName: "levels_store_id_fkey"
            columns: ["store_id"]
            isOneToOne: false
            referencedRelation: "stores"
            referencedColumns: ["id"]
      ...
      order_item_options: {
        ...
        Relationships: [
          {
            foreignKeyName: "order_item_options_level_id_fkey"
            columns: ["level_id"]
            isOneToOne: false
            referencedRelation: "levels"
            referencedColumns: ["id"]
      ...
      product_levels: {
        ...
        Relationships: [
          {
            foreignKeyName: "product_levels_level_id_fkey"
            columns: ["level_id"]
            isOneToOne: false
            referencedRelation: "levels"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "product_levels_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
